...
document.write("<br>"+charactersNames)
...
// Switch statement per rivelare la tipologia di carico
switch (true) {
  case crewMass < 500:
  ...
  case crewMass >= 1000:
    ...
    break;
  default:
    console.log("Errore: massa equipaggio non valida");
    break;}
...
or (let i = 0; i < starWarsCharacters.length; i++) {
